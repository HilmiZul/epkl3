...
class Siswa(models.Model):
    ...
    program_ahli  = models.ForeignKey(ProgramKeahlian, on_delete=models.CASCADE, null=True)
...
class Instansi(models.Model):
    ...
    jk               = models.CharField(max_length=5, choices=jk_choices, null=True, blank=True)
